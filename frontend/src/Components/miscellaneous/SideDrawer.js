...
import { BellIcon, ChevronDownIcon } from "@chakra-ui/react";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Right-side menu with bell icon and user avatar */}
        <Box>
          <Menu>
            <MenuButton p={1}>
              {/* <NotificationBadge
      ...
      <Drawer placement="left" onClose={onClose} isOpen={isOpen}>
        ...
        <DrawerContent>
          ...
          {/* Drawer body with search input and button */}
          <DrawerBody>
            ...
            <Box display="flex" alignItems="center">
              ...
              <Input
                ...
                mr={2} // Margin on the right to separate from button
